...
/**
 *  Created by WLH on 2015/5/29 10:01.
 */
public class WheelView extends ScrollView {
    ...
    private TextView createView(String item) {
        ...
        int padding = DipPxUtil.dip2px(context, 15);
        tv.setPadding(padding, padding, padding, padding);
        if (0 == itemHeight) {
            itemHeight = DipPxUtil.getViewMeasuredHeight(tv);
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                ...
                if(position - i == 1){
                    itemView.setTranslationY(itemHeight / 10);
                }else {
                ...
                if(position - i == 2){
                    itemView.setTranslationY(itemHeight / 2);
                }else {
                    itemView.setTranslationY(-(itemHeight / 2));
                ...
                itemView.setScaleY(0.3f);
                if(position - i > 0 ){
                    itemView.setTranslationY(-(itemHeight/4*3));
                }else {
                    itemView.setTranslationY(itemHeight/4*3);
                }
            }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(DipPxUtil.dip2px(context, 0.5f));
        }
