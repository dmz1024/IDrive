...
public class MapNowSearchActivity extends TRSFragmentActivity implements  PoiSearch.OnPoiSearchListener, View.OnClickListener {
        ...
        searchText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(keyword.trim().length() == 0){
                    Toast.makeText(MapNowSearchActivity.this, "请输入搜索关键字", Toast.LENGTH_SHORT).show();
                    return true;
                }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = View.inflate(MapNowSearchActivity.this, R.layout.grid_item_search, null);
            }
...
//        Layout_historyList.setVisibility(View.VISIBLE);
        ...
        LatLonPoint lp=HdMapActivity.lp;
        if (lp != null) {
...
//                        showSearchResult(poiItems);
                        ...
                        Toast.makeText(MapNowSearchActivity.this, "没有搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapNowSearchActivity.this, "没有搜索结果", Toast.LENGTH_SHORT).show();
...
//                    MapSearchActivity.this.startActivity(intent);
                    ...
                    SearchDetailMapActivity.CITY_NAME=CITY;
                    Intent mapIntent = new Intent();
                    mapIntent.putExtra("zoomLevel", 15f);
                    mapIntent.putExtra(SearchDetailMapActivity.EXTRA_VIEWPOTS, array);
        ...
        //          mapIntent.putExtra(LinesDetailImageTextActivity.EXTRA_LID, lid);
                    mapIntent.setClass(MapNowSearchActivity.this, SearchDetailMapActivity.class);
