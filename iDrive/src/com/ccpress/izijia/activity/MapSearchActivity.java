...
import com.ccpress.izijia.zxing.Intents;
 ...
 * 地图范围内检索
 */
public class MapSearchActivity extends TRSFragmentActivity implements  PoiSearch.OnPoiSearchListener, View.OnClickListener {
        ...
        searchText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(keyword.trim().length() == 0){
                    Toast.makeText(MapSearchActivity.this, "请输入搜索关键字", Toast.LENGTH_SHORT).show();
                    return true;
                }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = View.inflate(MapSearchActivity.this, R.layout.grid_item_search, null);
            }
...
//                        showSearchResult(poiItems);
                        ...
                        Toast.makeText(MapSearchActivity.this, "没有搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapSearchActivity.this, "没有搜索结果", Toast.LENGTH_SHORT).show();
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        Toast.makeText(MapSearchActivity.this, "没有搜索到数据", Toast.LENGTH_SHORT).show();
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    int temp=10;
                    temp = (arrayList.size()>10)? 10:arrayList.size();
                    ...
                    mapIntent.setClass(MapSearchActivity.this, LinesDetailMapActivity.class);
