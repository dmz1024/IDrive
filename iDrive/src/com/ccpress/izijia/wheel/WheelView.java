...
public class WheelView extends View {
	/** Scrolling duration */
	private static final int SCROLLING_DURATION = 100;//400
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 45;//15
...
//		setBackgroundResource(R.drawable.shape_wheel_bg);
		setBackgroundColor(getResources().getColor(R.color.idrive_white));
	}
...
//		bottomShadow.draw(canvas);
	...
	private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			int maxY = isCyclic ? 0x7FFFFFFF : (adapter.getItemsCount()/2)
					* getItemHeight();
