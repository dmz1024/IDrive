...
public class RefreshListView extends ListView implements OnScrollListener {
    ...
    private Mode mode;//设置是否下拉刷新和上拉加载
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.dfy_layout_fresh_head, null);
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.dfy_layout_fresh_footer, null);
    ...
    private void refreshHeaderView() {
        switch (currentState) {
            case PULL_REFRESH:
                Log.d("currentState", PULL_REFRESH + "");
                tv_state.setText("下拉刷新");
                iv_arrow.startAnimation(downAnimation);
                break;
            case RELEASE_REFRESH:
                Log.d("currentState", RELEASE_REFRESH + "");
                tv_state.setText("松开刷新");
                iv_arrow.startAnimation(upAnimation);
                break;
            case REFRESHING:
                Log.d("currentState", REFRESHING + "");
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (mode == Mode.BOTH || mode == Mode.END) {
