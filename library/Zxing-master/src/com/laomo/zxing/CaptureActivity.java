...
import com.laomo.zxing.decode.*;
import com.laomo.zxing.result.ResultButtonListener;
import com.laomo.zxing.result.ResultHandler;
import com.laomo.zxing.result.ResultHandlerFactory;
import com.laomo.zxing.util.Contant;
import com.laomo.zxing.view.ViewfinderView;
...
//        break;
//      case SETTINGS_ID:
//        intent.setClassName(this, Contant.class.getName());
//        startActivity(intent);
//        break;
//      case HELP_ID:
...
//  }
  ...
  public void handleDecode(Result rawResult, Bitmap barcode) {
    ...
    if (barcode == null) {
      ...
      switch (source) {
        ...
        case NONE:
          SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
          if (prefs.getBoolean(Contant.KEY_BULK_MODE, false)) {
  ...
  private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
      ...
      //play audio.
      try {
          AssetFileDescriptor afd = this.getResources().getAssets().openFd("beep.wav");
