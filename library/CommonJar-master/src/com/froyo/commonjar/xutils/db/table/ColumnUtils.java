...
package com.froyo.commonjar.xutils.db.table;
...
import com.froyo.commonjar.xutils.db.annotation.Check;
import com.froyo.commonjar.xutils.db.annotation.Column;
import com.froyo.commonjar.xutils.db.annotation.Finder;
import com.froyo.commonjar.xutils.db.annotation.Foreign;
import com.froyo.commonjar.xutils.db.annotation.Id;
import com.froyo.commonjar.xutils.db.annotation.NotNull;
import com.froyo.commonjar.xutils.db.annotation.Transient;
import com.froyo.commonjar.xutils.db.annotation.Unique;
import com.froyo.commonjar.xutils.db.converter.ColumnConverter;
import com.froyo.commonjar.xutils.db.converter.ColumnConverterFactory;
import com.froyo.commonjar.xutils.db.sqlite.FinderLazyLoader;
import com.froyo.commonjar.xutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.froyo.commonjar.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.froyo.commonjar.xutils.db.table.Finder finderColumn) {
