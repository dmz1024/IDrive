...
import com.froyo.commonjar.xutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.froyo.commonjar.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.froyo.commonjar.xutils.db.table.Id>();

    /* package */
    static synchronized com.froyo.commonjar.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.froyo.commonjar.xutils.db.table.Id id = new com.froyo.commonjar.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.froyo.commonjar.xutils.db.table.Id id = getId(entityType);
