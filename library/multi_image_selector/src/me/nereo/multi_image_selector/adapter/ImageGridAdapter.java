...
public class ImageGridAdapter extends BaseAdapter {
                ...
                holde.indicator.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(mImageSelectListener != null){
                            mImageSelectListener.onCheckClick(position, getItem(position));
                        }
                    }
                });
            }
        ...
        void bindData(final Image data){
            ...
            if(showSelectIndicator){
                ...
                if(mSelectedImages.contains(data)){
                    // 设置选中状态
                    indicator.setImageResource(R.drawable.btn_media_checked);
                    mask.setVisibility(View.VISIBLE);
                }else{
                    // 未选择
                    indicator.setImageResource(R.drawable.btn_media_unchecked);
    ...
    public interface OnImageSelectListener{
        void onCheckClick(int position, Image item);
    }
