package com.trs.view.loadingview;
...
public class LoadingView extends RelativeLayout {
    ...
    private static final int CIRCLE_BG_LIGHT = 0xFFFFFFFF;//0xFFFAFAFA
    private static final int DEFAULT_CIRCLE_TARGET = 64;
    private static final int CIRCLE_DIAMETER_Big = 65;
...
//        mProgress.setColorSchemeColors(0xff50bbdb);
        addView(mCircleView);
    }
